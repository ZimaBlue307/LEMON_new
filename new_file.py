...
class Module5_2(nn.Cell):

    def __init__(self, global_vars):
        super(Module5_2, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
        self.module0_1 = Module0(global_vars.get('module0_1_args'))
...
class Module5_1(nn.Cell):

    def __init__(self, global_vars):
        super(Module5_1, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
        self.module0_1 = Module0(global_vars.get('module0_1_args'))
...
class MindSporeModel(nn.Cell):
    ...
    def __init__(self, global_vars):
        ...
        self.module2_0 = Module2(global_vars.get('module2_0_args'))
        self.conv2d_3 = getattr(self._handler, 'conv2d_3')
        self.module2_1 = Module2(global_vars.get('module2_1_args'))
        self.module2_2 = Module2(global_vars.get('module2_2_args'))
        self.conv2d_8 = getattr(self._handler, 'conv2d_8')
        self.module5_0 = Module5(global_vars.get('module5_0_args'))
        self.conv2d_26 = getattr(self._handler, 'conv2d_26')
        self.module3_0 = Module3(global_vars.get('module3_0_args'))
        self.module5_1 = Module5_1(global_vars.get('module5_1_args'))
        self.conv2d_51 = getattr(self._handler, 'conv2d_51')
        self.module3_1 = Module3_1(global_vars.get('module3_1_args'))
        self.module5_2 = Module5_2(global_vars.get('module5_2_args'))
