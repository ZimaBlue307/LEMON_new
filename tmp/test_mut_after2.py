...
class Module5Opt_5(nn.Cell):

    def __init__(self, global_vars):
        super(Module5Opt_5, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0Opt_8(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
        self.module0_1 = Module0Opt_8(global_vars.get('module0_1_args'))
...
class Module3Opt_3(nn.Cell):

    def __init__(self, global_vars):
        super(Module3Opt_3, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0Opt_8(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
...
class Module5Opt_4(nn.Cell):

    def __init__(self, global_vars):
        super(Module5Opt_4, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0Opt_8(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
        self.module0_1 = Module0Opt_8(global_vars.get('module0_1_args'))
...
class Module3Opt_2(nn.Cell):

    def __init__(self, global_vars):
        super(Module3Opt_2, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0Opt_8(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
...
class Module0Opt_8(nn.Cell):

    def __init__(self, global_vars):
        super(Module0Opt_8, self).__init__()
        self._handler = global_vars.get('handler')
...
class Module5Opt_3(nn.Cell):

    def __init__(self, global_vars):
        super(Module5Opt_3, self).__init__()
        self._handler = global_vars.get('handler')
        self.module0_0 = Module0Opt_8(global_vars.get('module0_0_args'))
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
        self.module0_1 = Module0Opt_8(global_vars.get('module0_1_args'))
...
class Module2Opt_3(nn.Cell):

    def __init__(self, global_vars):
        super(Module2Opt_3, self).__init__()
        self._handler = global_vars.get('handler')
        self.conv2d_0 = getattr(self._handler, 'conv2d_0')
        self.relu_1 = getattr(self._handler, 'relu_1')
...
class MindSporeModelOpt_1(nn.Cell):

    def __init__(self, global_vars):
        super(MindSporeModelOpt_1, self).__init__()
        self._handler = global_vars.get('handler')
        self.transpose_0 = getattr(self._handler, 'transpose_0')
        self.module2_0 = Module2Opt_3(global_vars.get('module2_0_args'))
        self.conv2d_3 = getattr(self._handler, 'conv2d_3')
        self.module2_1 = Module2Opt_3(global_vars.get('module2_1_args'))
        self.module2_2 = Module2Opt_3(global_vars.get('module2_2_args'))
        self.conv2d_8 = getattr(self._handler, 'conv2d_8')
        self.module5_0 = Module5Opt_3(global_vars.get('module5_0_args'))
        self.conv2d_26 = getattr(self._handler, 'conv2d_26')
        self.module3_0 = Module3Opt_2(global_vars.get('module3_0_args'))
        self.module5_1 = Module5Opt_4(global_vars.get('module5_1_args'))
        self.conv2d_51 = getattr(self._handler, 'conv2d_51')
        self.module3_1 = Module3Opt_3(global_vars.get('module3_1_args'))
        self.module5_2 = Module5Opt_5(global_vars.get('module5_2_args'))
