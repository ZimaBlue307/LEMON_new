...
if __name__ == "__main__":
    ...
    param_dict = mindspore.load_checkpoint(f'resnet20_cifar100_origin/resnet20_cifar100_origin.ckpt')
    mindspore.load_param_into_net(network, param_dict)
    input1=Tensor(np.random.randn(2,3,227,227),dtype=mindspore.float32)
    network_ast = astor.code_to_ast.parse_file(f'resnet20_cifar100_origin/resnet20_cifar100_origin.py')
