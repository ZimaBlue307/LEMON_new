...
# mindspore.set_context(mode=mindspore.GRAPH_MODE, device_target='CPU',save_graphs=True, save_graphs_path="./data")

context.set_context(mode=context.GRAPH_MODE)
context.set_context(save_graphs=True, save_graphs_path="./data")
...
#Manually copy a layer: copy Module2.conv2d_0
class Module2_copy(nn.Cell):
    ...
    def __init__(self, conv2d_0_in_channels, conv2d_0_kernel_size, conv2d_0_padding, conv2d_0_pad_mode):
        ...
        self.conv2d_0 = nn.Conv2d(in_channels=conv2d_0_in_channels,
                                  ...
                                  group=1,
                                  has_bias=True)
        self.conv2d_0_copy = nn.Conv2d(in_channels=conv2d_0_in_channels,
                                  out_channels=16,
                                  kernel_size=conv2d_0_kernel_size,
                                  stride=(1, 1),
                                  padding=conv2d_0_padding,
...
class Module5(nn.Cell):
    ...
    def __init__(self, conv2d_0_in_channels, conv2d_0_out_channels, conv2d_2_in_channels, conv2d_2_out_channels,
        ...
        self.conv2d_2 = nn.Conv2d(in_channels=conv2d_2_in_channels,
                                  ...
                                  group=1,
                                  has_bias=True)
        self.add = mindspore.ops.Add() #添加入__init__以帮助模型可以转换为symboltree
...
class Module3(nn.Cell):
    ...
    def __init__(self, conv2d_0_in_channels, conv2d_0_out_channels, module0_0_batchnorm2d_0_num_features,
                 module0_0_conv2d_2_in_channels, module0_0_conv2d_2_out_channels, module0_0_conv2d_2_stride,
                 module0_0_conv2d_4_in_channels, module0_0_conv2d_4_out_channels):
...
class MindSporeModel(nn.Cell):
    ...
    def __init__(self):
        ...
        self.module2_0 = Module2(conv2d_0_in_channels=3,
                                 conv2d_0_kernel_size=(3, 3),
                                 conv2d_0_padding=(1, 1, 1, 1),
                                 conv2d_0_pad_mode="pad")
        # self.module2_0_copylayer = Module2_copy(conv2d_0_in_channels=3,
        #                          conv2d_0_kernel_size=(3, 3),
        #                          conv2d_0_padding=(1, 1, 1, 1),
        #                          conv2d_0_pad_mode="pad")
        self.conv2d_3 = nn.Conv2d(in_channels=16,
                                  ...
                                  group=1,
                                  has_bias=True)
        self.module2_1 = Module2(conv2d_0_in_channels=16,
                                 conv2d_0_kernel_size=(1, 1),
                                 conv2d_0_padding=0,
                                 conv2d_0_pad_mode="valid")
        #在这里插入一层
        self.module2_1_copy = Module2_copy(conv2d_0_in_channels=16,
                                 conv2d_0_kernel_size=(1, 1),
                                 conv2d_0_padding=0,
                                 conv2d_0_pad_mode="valid")


        self.module2_2 = Module2(conv2d_0_in_channels=16,
                                 conv2d_0_kernel_size=(3, 3),
                                 conv2d_0_padding=(1, 1, 1, 1),
                                 conv2d_0_pad_mode="pad")
        self.conv2d_8 = nn.Conv2d(in_channels=16,
                                  ...
                                  group=1,
                                  has_bias=True)
        self.module5_0 = Module5(conv2d_0_in_channels=16,
        ...
        self.module5_1 = Module5(conv2d_0_in_channels=64,
                                 conv2d_0_out_channels=128,
        ...
        self.module5_2 = Module5(conv2d_0_in_channels=128,
                                 conv2d_0_out_channels=256,
                                 conv2d_2_in_channels=128,
                                 conv2d_2_out_channels=256,
                                 module0_0_batchnorm2d_0_num_features=256,
                                 module0_0_conv2d_2_in_channels=256,
                                 module0_0_conv2d_2_out_channels=128,
                                 module0_0_conv2d_2_stride=(1, 1),
                                 module0_0_conv2d_4_in_channels=128,
                                 module0_0_conv2d_4_out_channels=128,
                                 module0_1_batchnorm2d_0_num_features=256,
        ...
        self.add = mindspore.ops.Add()#添加入__init__以帮助模型可以转换为symboltree
        self.matmul = mindspore.ops.MatMul()#添加入__init__以帮助模型可以转换为symboltree
    ...
    def construct(self, input_1):
        ...
        module2_1_opt = self.module2_1_copy(module2_0_opt) # used to be: module2_1_opt = self.module2_1(module2_0_opt)
