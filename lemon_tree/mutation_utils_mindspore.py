class LayerUtils:
    ...
    def __init__(self):
        ...
        self.available_model_level_layers['AdaptiveMaxPool1d_layer'] = LayerUtils.AdaptiveMaxPool1d_layer
        self.available_model_level_layers['AdaptiveMaxPool2d_layer'] = LayerUtils.AdaptiveMaxPool2d_layer
        self.available_model_level_layers['AdaptiveMaxPool3d_layer'] = LayerUtils.AdaptiveMaxPool3d_layer
        self.available_model_level_layers['AdaptiveAvgPool1d_layer'] = LayerUtils.AdaptiveAvgPool1d_layer
        self.available_model_level_layers['AdaptiveAvgPool2d_layer'] = LayerUtils.AdaptiveAvgPool2d_layer
        self.available_model_level_layers['AdaptiveAvgPool3d_layer'] = LayerUtils.AdaptiveAvgPool3d_layer
        self.available_model_level_layers['FractionalMaxPool2d_layer'] = LayerUtils.FractionalMaxPool2d_layer
        self.available_model_level_layers['FractionalMaxPool3d_layer'] = LayerUtils.FractionalMaxPool3d_layer
